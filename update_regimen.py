...
# Find and replace the plan block
start_idx = -1
end_idx = -1
for i, line in enumerate(lines):
    if 'const PLAN_JAN_18 = {' in line:
        start_idx = i
...
if start_idx != -1 and end_idx != -1:
    lines[start_idx:end_idx+1] = [new_plan]

# Update migration keys
final_lines = []
for line in lines:
    new_line = line.replace("regimen_migration_task_22_v6", "regimen_migration_task_22_v60")
    new_line = new_line.replace("regimen_migration_task_22_v10", "regimen_migration_task_22_v60")
